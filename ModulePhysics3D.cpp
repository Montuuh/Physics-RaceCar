...
PhysVehicle3D* ModulePhysics3D::AddVehicle(const VehicleInfo& info)
{
	...
	btCollisionShape* colShape = new btBoxShape(btVector3(info.carShape_size.x*0.5f, info.carShape_size.y*0.5f, info.carShape_size.z*0.5f));
	shapes.add(colShape);

	btTransform trans;
	trans.setIdentity();
	trans.setOrigin(btVector3(info.carShape_offset.x, info.carShape_offset.y, info.carShape_offset.z));
